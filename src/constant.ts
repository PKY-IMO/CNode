export const CONSTANTS = {
    SIMPLE_ITEMS: BI.map("柳州市城贸金属材料有限责任公司 柳州市建福房屋租赁有限公司 柳州市迅昌数码办公设备有限责任公司 柳州市河海贸易有限责任公司 柳州市花篮制衣厂 柳州市兴溪物资有限公司 柳州市针织总厂 柳州市衡管物资有限公司 柳州市琪成机电设备有限公司 柳州市松林工程机械修理厂".match(/[^\s]+/g), (_i, v) => {
        return {
            text: v,
            value: v,
            title: v,
    ...
    COLORS: [{
        text: "默认",
        value: "默认",
        colors: ["#498bd8", "#4dacdf", "#8fcaf3", "#fba750", "#ffc17d", "#91d482", "#63ab59", "#7fcac6", "#02a6bb", "#60c2e3", "#e9c8c1", "#e4735d", "#498bd8", "#4dacdf", "#8fcaf3", "#fba750", "#ffc17d", "#91d482", "#63ab59", "#7fcac6", "#02a6bb", "#60c2e3", "#e9c8c1", "#e4735d", "#498bd8", "#4dacdf", "#8fcaf3", "#fba750", "#ffc17d", "#91d482", "#63ab59", "#7fcac6"],
    },
    {
        text: "彩虹",
        value: "彩虹",
        colors: ["#fae800", "#00c039", "#0482dc", "#ff2637", "#ff7701", "#9c5ec3", "#00ccdf", "#537fe0", "#bd4d85", "#f469c7", "#fdc450", "#abec78", "#fae800", "#00c039", "#0482dc", "#ff2637", "#ff7701", "#9c5ec3", "#00ccdf", "#537fe0", "#bd4d85", "#f469c7", "#fdc450", "#abec78", "#fae800", "#00c039", "#0482dc", "#ff2637", "#ff7701", "#9c5ec3", "#00ccdf", "#537fe0"],
    },
    {
        text: "温暖",
        value: "温暖",
        colors: ["#b25657", "#e18169", "#f1c15f", "#f4ab98", "#c82d31", "#fa706d", "#f7a553", "#9b755e", "#bfa395", "#8d9a90", "#4c9f95", "#587d85", "#6388b4", "#b25657", "#e18169", "#f1c15f", "#f4ab98", "#fa706d", "#f7a553", "#9b755e", "#bfa395", "#8d9a90", "#4c9f95", "#587d85", "#6388b4", "#b25657", "#e18169", "#f1c15f", "#f4ab98", "#fa706d", "#f7a553", "#bfa395"],
    },
    {
        text: "轻柔",
        value: "轻柔",
        colors: ["#00ceb2", "#e0e5ad", "#e18169", "#79b786", "#9ed6c9", "#f3aa97", "#bfa395", "#9b755e", "#f1c15f", "#57af7f", "#a4dd99", "#f28e2c", "#00ceb2", "#e0e5ad", "#e18169", "#79b786", "#9ed6c9", "#f3aa97", "#bfa395", "#9b755e", "#f1c15f", "#57af7f", "#a4dd99", "#f28e2c", "#00ceb2", "#e0e5ad", "#e18169", "#79b786", "#9ed6c9", "#f3aa97", "#bfa395", "#9b755e"],
    },
    {
        text: "浅色炫彩",
        value: "浅色炫彩",
        colors: ["#00c5dc", "#5867c3", "#ff525e", "#ffa9cc", "#ffaa00", "#ffdb03", "#9ccc66", "#36c398", "#00a7af", "#2281bc", "#766aef", "#c576d3", "#00c5dc", "#5867c3", "#ff525e", "#ffa9cc", "#ffaa00", "#ffdb03", "#9ccc66", "#36c398", "#00a7af", "#2281bc", "#766aef", "#c576d3", "#00c5dc", "#5867c3", "#ff525e", "#ffa9cc", "#ffaa00", "#ffdb03", "#9ccc66", "#36c398"],
    },
    {
        text: "蓝色",
        value: "蓝色",
    ...
    },
    {
        text: "红色",
        value: "红色",
        colors: ["#da195c", "#e6658e", "#f3b2c3", "#de3352", "#e65a68", "#f29ba1", "#e54542", "#ed7068", "#f29f96", "#e66943", "#f08c67", "#fabca0", "#da195c", "#e6658e", "#f3b2c3", "#de3352", "#e65a68", "#f29ba1", "#e54542", "#ed7068", "#f29f96", "#e66943", "#f08c67", "#fabca0", "#da195c", "#e6658e", "#f3b2c3", "#de3352", "#e65a68", "#f29ba1", "#e54542", "#ed7068"],
    },
    {
        text: "绿色",
        value: "绿色",
        colors: ["#55b83a", "#8acf7b", "#c3e7bd", "#56c050", "#72cd75", "#aae3ae", "#5ec86e", "#7fd690", "#a6e2b4", "#5fc986", "#7fd8a3", "#afeac9", "#55b83a", "#8acf7b", "#c3e7bd", "#56c050", "#72cd75", "#aae3ae", "#5ec86e", "#7fd690", "#a6e2b4", "#5fc986", "#7fd8a3", "#afeac9", "#55b83a", "#8acf7b", "#c3e7bd", "#56c050", "#72cd75", "#aae3ae", "#5ec86e", "#7fd690"],
    },
    {
        text: "灰色",
        value: "灰色",
        colors: ["#4a4a4a", "#9a9a9a", "#cccccc", "#666666", "#a6a6a6", "#d9d9d9", "#808080", "#b3b3b3", "#e6e6e6", "#8c8c8c", "#bfbfbf", "#f2f2f2", "#4a4a4a", "#9a9a9a", "#cccccc", "#666666", "#a6a6a6", "#d9d9d9", "#808080", "#b3b3b3", "#e6e6e6", "#8c8c8c", "#bfbfbf", "#f2f2f2", "#4a4a4a", "#9a9a9a", "#cccccc", "#666666", "#a6a6a6", "#d9d9d9", "#808080", "#b3b3b3"],
    },
    {
        text: "朝霞",
        value: "朝霞",
        colors: ["#d7f0f7", "#99b3cc", "#9da5bc", "#bec2cd", "#beb9c0", "#ecaca3", "#b28d94", "#594662", "#4e4967", "#384064", "#24385d", "#16324a", "#d7f0f7", "#99b3cc", "#9da5bc", "#bec2cd", "#beb9c0", "#ecaca3", "#b28d94", "#594662", "#4e4967", "#384064", "#24385d", "#16324a", "#d7f0f7", "#99b3cc", "#9da5bc", "#bec2cd", "#beb9c0", "#ecaca3", "#b28d94", "#594662"],
    },
    {
        text: "晚霞",
        value: "晚霞",
        colors: ["#323987", "#3955b9", "#5f65d3", "#714fad", "#b763b1", "#e97393", "#282e6c", "#2e4494", "#4c5ea9", "#5a3f8a", "#924f8e", "#ba5c76", "#323987", "#3955b9", "#5f65d3", "#714fad", "#b763b1", "#e97393", "#282e6c", "#2e4494", "#4c5ea9", "#5a3f8a", "#924f8e", "#ba5c76", "#323987", "#3955b9", "#5f65d3", "#714fad", "#b763b1", "#e97393", "#282e6c", "#2e4494"],
    },
    {
        text: "冰川",
        value: "冰川",
        colors: ["#867a84", "#a29baa", "#d1cfd4", "#cbd8e1", "#6689a7", "#1e2d4e", "#6b626a", "#827c88", "#a7a6aa", "#a2adb4", "#526e86", "#18243e", "#867a84", "#a29baa", "#d1cfd4", "#cbd8e1", "#6689a7", "#1e2d4e", "#6b626a", "#827c88", "#a7a6aa", "#a2adb4", "#526e86", "#18243e", "#867a84", "#a29baa", "#d1cfd4", "#cbd8e1", "#6689a7", "#1e2d4e", "#6b626a", "#827c88"],
    },
    {
        text: "文艺",
        value: "文艺",
        colors: ["#fccfb8", "#e2beb2", "#d3c5ba", "#cfd3c4", "#cbd8c6", "#e0dcc3", "#cbc8a9", "#b3a28e", "#c4ab8c", "#c69577", "#b88766", "#8c4d2e", "#fccfb8", "#e2beb2", "#d3c5ba", "#cfd3c4", "#cbd8c6", "#e0dcc3", "#cbc8a9", "#b3a28e", "#c4ab8c", "#c69577", "#b88766", "#8c4d2e", "#fccfb8", "#e2beb2", "#d3c5ba", "#cfd3c4", "#cbd8c6", "#e0dcc3", "#cbc8a9", "#b3a28e"],
    },
    {
        text: "柔彩",
        value: "柔彩",
        colors: ["#d36534", "#ef903e", "#f5be7e", "#bfa395", "#8d9a90", "#4c9f95", "#559191", "#587d85", "#466172", "#86858a", "#7b6f79", "#b68b85", "#d36534", "#ef903e", "#f5be7e", "#bfa395", "#8d9a90", "#4c9f95", "#559191", "#587d85", "#466172", "#86858a", "#7b6f79", "#b68b85", "#d36534", "#ef903e", "#f5be7e", "#bfa395", "#8d9a90", "#4c9f95", "#559191", "#587d85"],
    },
    {
        text: "明亮",
        value: "明亮",
        colors: ["#0e72cc", "#6ca30f", "#f59311", "#fa4343", "#16afcc", "#85c021", "#d12a6a", "#0e72cc", "#6ca30f", "#f59311", "#fa4343", "#16afcc", "#85c021", "#d12a6a", "#0e72cc", "#6ca30f", "#f59311", "#fa4343", "#16afcc", "#85c021", "#d12a6a", "#0e72cc", "#6ca30f", "#f59311", "#fa4343", "#16afcc", "#85c021", "#d12a6a", "#0e72cc", "#6ca30f", "#f59311", "#fa4343"],
    },
    {
        text: "雅致",
        value: "雅致",
        colors: ["#3682be", "#45a776", "#f05326", "#eed777", "#334f65", "#b3974e", "#38cb7d", "#ddae33", "#844bb3", "#93c555", "#5f6694", "#df3881", "#2e9296", "#3682be", "#45a776", "#f05326", "#eed777", "#334f65", "#b3974e", "#38cb7d", "#ddae33", "#844bb3", "#93c555", "#5f6694", "#df3881", "#2e9296", "#3682be", "#45a776", "#f05326", "#eed777", "#334f65", "#b3974e"],
    },
    {
        text: "柔和",
        value: "柔和",
        colors: ["#5b9bd5", "#ed7d31", "#70ad47", "#ffc000", "#4472c4", "#91d024", "#b235e6", "#02ae75", "#5b9bd5", "#ed7d31", "#70ad47", "#ffc000", "#4472c4", "#91d024", "#b235e6", "#02ae75", "#5b9bd5", "#ed7d31", "#70ad47", "#ffc000", "#4472c4", "#91d024", "#b235e6", "#02ae75", "#5b9bd5", "#ed7d31", "#70ad47", "#ffc000", "#4472c4", "#91d024", "#b235e6", "#02ae75"],
    },
    {
        text: "淡雅",
        value: "淡雅",
    ...
    },
    {
        text: "复古",
        value: "复古",
        colors: ["#0780cf", "#765005", "#fa6d1d", "#0e2c82", "#b6b51f", "#da1f18", "#701866", "#f47a75", "#009db2", "#024b51", "#0780cf", "#765005", "#fa6d1d", "#0e2c82", "#b6b51f", "#da1f18", "#701866", "#f47a75", "#009db2", "#024b51", "#0780cf", "#765005", "#fa6d1d", "#0e2c82", "#b6b51f", "#da1f18", "#701866", "#f47a75", "#009db2", "#024b51", "#0780cf", "#765005"],
    },
    {
        text: "商务",
        value: "商务",
        colors: ["#194f97", "#555555", "#bd6b08", "#00686b", "#c82d31", "#625ba1", "#898989", "#9c9800", "#007f54", "#a195c5", "#103667", "#f19272", "#c18c00", "#363636", "#426fb3", "#66bf7f", "#f9cd76", "#392884", "#00ae71", "#93aad6", "#490761", "#faf14b", "#955305", "#016241", "#7388c1", "#8f1e20", "#f9cd76", "#d69b01", "#b7b7b7", "#511f90", "#99d0b9", "#c7c300"],
    },
    {
        text: "清新",
        value: "清新",
        colors: ["#00a8e1", "#99cc00", "#e30039", "#fcd300", "#800080", "#00994e", "#ff6600", "#808000", "#db00c2", "#008080", "#0000ff", "#c8cc00", "#001285", "#00cacc", "#e03800", "#fa9b00", "#850a00", "#990089", "#bf6600", "#00bf5e", "#8d00dc", "#faf100", "#955300", "#006241", "#7388c1", "#8f1e20", "#f9cd76", "#d69b01", "#b7b7b7", "#511f90", "#99d0b9", "#c7c300"],
    },
    {
        text: "经典",
        value: "经典",
        colors: ["#002c53", "#ffa510", "#0c84c6", "#ffbd66", "#f74d4d", "#2455a4", "#41b7ac", "#002c53", "#ffa510", "#0c84c6", "#ffbd66", "#f74d4d", "#2455a4", "#41b7ac", "#002c53", "#ffa510", "#0c84c6", "#ffbd66", "#f74d4d", "#2455a4", "#41b7ac", "#002c53", "#ffa510", "#0c84c6", "#ffbd66", "#f74d4d", "#2455a4", "#41b7ac", "#002c53", "#ffa510", "#0c84c6", "#ffbd66"],
    },
    {
        text: "渐变",
        value: "渐变",
        colors: ["#71ae46", "#96b744", "#c4cc38", "#ebe12a", "#eab026", "#e3852b", "#d85d2a", "#ce2626", "#ac2026", "#71ae46", "#96b744", "#c4cc38", "#ebe12a", "#eab026", "#e3852b", "#d85d2a", "#ce2626", "#ac2026", "#71ae46", "#96b744", "#c4cc38", "#ebe12a", "#eab026", "#e3852b", "#d85d2a", "#ce2626", "#ac2026", "#71ae46", "#96b744", "#c4cc38", "#ebe12a", "#eab026"],
    },
    {
        text: "怀旧",
        value: "怀旧",
        colors: ["#3b6291", "#943c39", "#779043", "#624c7c", "#388498", "#bf7334", "#3f6899", "#9c403d", "#7d9847", "#675083", "#3b8ba1", "#c97937", "#426da1", "#a44340", "#849f4b", "#6c548a", "#3f92a9", "#d37f3a", "#4572a7", "#aa4643", "#89a54e", "#71588f", "#4198af", "#db843d", "#4876ae", "#b14946", "#8eac51", "#755b95", "#449eb6", "#e48a40", "#4b7bb4", "#b74c49"],
    },
    {
        text: "自然",
        value: "自然",
        colors: ["#4bbc63", "#59c9ef", "#ff855e", "#69d6c1", "#ffe342", "#2376c9", "#6699ff", "#59c68d", "#a9dd66", "#f987a2", "#f7c263", "#f19272", "#c18c00", "#363636", "#426fb3", "#66bf7f", "#f9cd76", "#392884", "#00ae71", "#93aad6", "#490761", "#faf14b", "#955305", "#016241", "#7388c1", "#8f1e20", "#f9cd76", "#d69b01", "#b7b7b7", "#511f90", "#99d0b9", "#c7c300"],
    },
    {
        text: "秋落",
        value: "秋落",
        colors: ["#b25757", "#e18169", "#f1c15f", "#f4ab98", "#fa706d", "#f7a552", "#9c755f", "#bfa395", "#8d9a90", "#4c9f95", "#587d85", "#6388b4", "#b25757", "#e18169", "#f1c15f", "#f4ab98", "#fa706d", "#f7a552", "#9c755f", "#bfa395", "#8d9a90", "#4c9f95", "#587d85", "#6388b4", "#b25757", "#e18169", "#f1c15f", "#f4ab98", "#fa706d", "#f7a552", "#9c755f", "#bfa395"],
    },
    {
        text: "未来",
        value: "未来",
        colors: ["#3ae8ef", "#3ad0f9", "#78fd84", "#068eea", "#01bdbe", "#0373a1", "#f86a8c", "#d63d65", "#f4ab98", "#ffcd40", "#f28e2b", "#05a6bb", "#3ae8ef", "#3ad0f9", "#78fd84", "#068eea", "#01bdbe", "#0373a1", "#f86a8c", "#d63d65", "#f4ab98", "#ffcd40", "#f28e2b", "#05a6bb", "#3ae8ef", "#3ad0f9", "#78fd84", "#068eea", "#01bdbe", "#0373a1", "#f86a8c", "#d63d65"],
    },
    {
        text: "格调",
        value: "格调",
        colors: ["#3eadff", "#7d84ff", "#e186f7", "#fa5084", "#f9d023", "#f2901c", "#9d5ec4", "#749af7", "#6443ef", "#124bd8", "#3386ff", "#12c495", "#3eadff", "#7d84ff", "#e186f7", "#fa5084", "#f9d023", "#f2901c", "#9d5ec4", "#749af7", "#6443ef", "#124bd8", "#3386ff", "#12c495", "#3eadff", "#7d84ff", "#e186f7", "#fa5084", "#f9d023", "#f2901c", "#9d5ec4", "#749af7"],
    },
    {
        text: "别致",
        value: "别致",
        colors: ["#3195d3", "#68e1ea", "#f47398", "#27b3c3", "#67c9f4", "#f4b66c", "#6d6d84", "#b9d51f", "#007f54", "#a195c5", "#103667", "#f19272", "#c18c00", "#363636", "#426fb3", "#66bf7f", "#f9cd76", "#392884", "#00ae71", "#93aad6", "#490761", "#faf14b", "#955305", "#016241", "#7388c1", "#8f1e20", "#f9cd76", "#d69b01", "#b7b7b7", "#511f90", "#99d0b9", "#c7c300"],
    },
    {
        text: "活力",
        value: "活力",
        colors: ["#7267e6", "#55bef2", "#3fb27e", "#f95284", "#f8d126", "#da79f2", "#9ccc66", "#f88d48", "#68d4db", "#5182e4", "#5156b8", "#8854d4", "#7267e6", "#55bef2", "#3fb27e", "#f95284", "#f8d126", "#da79f2", "#9ccc66", "#f88d48", "#68d4db", "#5182e4", "#5156b8", "#8854d4", "#7267e6", "#55bef2", "#3fb27e", "#f95284", "#f8d126", "#da79f2", "#9ccc66", "#f88d48"],
    },
    {
        text: "琥珀",
        value: "琥珀",
        colors: ["#974337", "#998f53", "#e1d09f", "#6d735a", "#e39971", "#db5446", "#e78250", "#dba947", "#bfa76f", "#dcb3a2", "#7a6b68", "#bcb0ab", "#974337", "#998f53", "#e1d09f", "#6d735a", "#e39971", "#db5446", "#e78250", "#dba947", "#bfa76f", "#dcb3a2", "#7a6b68", "#bcb0ab", "#974337", "#998f53", "#e1d09f", "#6d735a", "#e39971", "#db5446", "#e78250", "#dba947"],
    },
    {
        text: "石青",
        value: "石青",
        colors: ["#4a72c9", "#42a3b7", "#a1cb80", "#729e90", "#4294b8", "#8aa0d3", "#5f71c6", "#a3ccf7", "#479ce2", "#6087bf", "#3d8a6f", "#76b55f", "#4a72c9", "#42a3b7", "#a1cb80", "#729e90", "#4294b8", "#8aa0d3", "#5f71c6", "#a3ccf7", "#479ce2", "#6087bf", "#3d8a6f", "#76b55f", "#4a72c9", "#42a3b7", "#a1cb80", "#729e90", "#4294b8", "#8aa0d3", "#5f71c6", "#a3ccf7"],
    },
    {
        text: "现代",
        value: "现代",
        colors: ["#4fdfff", "#42a0f7", "#5a6eff", "#26e0a5", "#00b2da", "#2871d3", "#ffcf48", "#ffa343", "#89f4c2", "#78d56c", "#38975a", "#8b78fa", "#4fdfff", "#42a0f7", "#5a6eff", "#26e0a5", "#00b2da", "#2871d3", "#ffcf48", "#ffa343", "#89f4c2", "#78d56c", "#38975a", "#8b78fa", "#4fdfff", "#42a0f7", "#5a6eff", "#26e0a5", "#00b2da", "#2871d3", "#ffcf48", "#ffa343"],
    }],
};
